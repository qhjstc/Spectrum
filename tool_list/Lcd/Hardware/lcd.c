...
//////////////////////////////////////////////////////////////////////////////////	 
/*
在使用STM32Cube的时候记得要更改FMC_NE1      PD7
记得开背光PB
*/
//////////////////////////////////////////////////////////////////////////////////	 
...
void LCD_Refresh(u16 sx,u16 sy,u16 ex,u16 ey, uint32_t* data){
    u16 i,j;
    u16 xlen=0;
    xlen=ex-sx+1;
    printf("ok\r\n");
    for(i=sy;i<=ey;i++){
        ...
        LCD_WriteRAM_Prepare();     			//开始写入GRAM
        for(j=0;j<xlen;j++){
            printf("%d\r\n", *(data + i*lcddev.height + sx + j));
            LCD->LCD_RAM= *(data + i*lcddev.height + sx + j);                 //显示颜色
        }
    }
}