...
// 这里注意一下 因为MOSI引脚是15，所以......
//IO方向设置
#define CT_SDA_IN()  {T_MOSI_GPIO_Port->MODER&=~(3<<(15*2));T_MOSI_GPIO_Port->MODER|=0<<15*2;}	//PI3输入模式
#define CT_SDA_OUT() {T_MOSI_GPIO_Port->MODER&=~(3<<(15*2));T_MOSI_GPIO_Port->MODER|=1<<15*2;} 	//PI3输出模式
//IO操作函数	 
...
#define CT_READ_SDA   HAL_GPIO_ReadPin(T_MOSI_GPIO_Port,T_MOSI_Pin)//输入SDA
